...
public class EPKeyRegistry implements com.honeybeedev.exclusiveprison.api.key.KeyRegistry {
    ...
    private final SyncClearable<Map<String, EPKeyRegistry>> subRegistries = new SyncClearable<>(
        new TreeMap<>(String.CASE_INSENSITIVE_ORDER));
    private final SyncClearable<Map<String, EPrisonKey>> keys = new SyncClearable<>(
        new TreeMap<>(String.CASE_INSENSITIVE_ORDER));
